...
L["HELP_GENERAL"] = "General help"

L["HELP_FAQ_Q1"] = "Why doesn't my gear show up?"
L["HELP_FAQ_A1"] = "Guildbook will scan the Blizzard equipment manager for your equipment sets, at present this doesnt include data on item gems or enchants. The equipment sets are then shared with yor guild"
