...
L["UPDATE_NEWS"] = [[
"Quick fix for enchanters where a spelling error (well capital letter error) was causing a bug, sorry about that."
]]
...
elseif locale == 'frFR' then
	L["UPDATE_NEWS"] = [[
Fix pour les enchanteurs où une faute de frappe (majuscule) causait des bugs, désolé.
-Stpain
