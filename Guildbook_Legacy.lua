...
|cff00BFF3 |r
    ...
    self.GuildFrame.GuildBankFrame.BankMoney = self.GuildFrame.GuildBankFrame:CreateFontString('$parentBankMoney', 'OVERLAY', 'GameFontNormalSmall')
    self.GuildFrame.GuildBankFrame.BankMoney:SetPoint('TOPLEFT', Guildbook.GuildFrame.GuildBankFrame.CommitBankCharacter, 'BOTTOMLEFT', 0, -2)
    self.GuildFrame.GuildBankFrame.BankMoney:SetSize(220, 20)
    self.GuildFrame.GuildBankFrame.BankMoney:SetTextColor(1,1,1,1)
