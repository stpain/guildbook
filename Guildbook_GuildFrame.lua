...
function Guildbook:SetupProfilesFrame()
    ...
    self.GuildFrame.ProfilesFrame.SearchBox:SetSize(240, 22)
    ...
    self.GuildFrame.ProfilesFrame.Searchbutton = CreateFrame("BUTTON", "GuildbookProfileFrameSearchButton", self.GuildFrame.ProfilesFrame, "UIPanelButtonTemplate")
    self.GuildFrame.ProfilesFrame.Searchbutton:SetPoint("LEFT", self.GuildFrame.ProfilesFrame.SearchBox, "RIGHT", 10, 0)
    self.GuildFrame.ProfilesFrame.Searchbutton:SetText(L['Search'])
    self.GuildFrame.ProfilesFrame.Searchbutton:SetSize(60, 20)
    self.GuildFrame.ProfilesFrame.Searchbutton:SetScript("OnClick", function()
        Guildbook.GuildFrame.ProfilesFrame:SearchText_OnChanged(Guildbook.GuildFrame.ProfilesFrame.SearchBox:GetText())
    end)
