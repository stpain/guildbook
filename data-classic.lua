...
local PROF_CONTENT = "profContent"
local NORMAL_DIFF = "normal"
local LEATHER_DIFF, MAIL_DIFF, PLATE_DIFF = "leather", "mail", "plate"
local PROF_ITTYPE = "profItype"
local NORMAL_ITTYPE = "normItype"

local GEM_FORMAT1 = "Gem1"

local PROF_SEC_CONTENT, PROF_CONTENT = "secCon", "con"
local AL, ALIL = {}, {}
