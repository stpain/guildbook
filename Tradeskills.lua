...
function Tradeskills:GetLocaleNameFromEnglish(tradeskill)
    ...
    return self.TradeskillIDsToLocaleName[self.CurrentLocale][id];
end

function Tradeskills:GetLocaleNameFromID(id)
	if self.TradeskillIDsToLocaleName[GetLocale()] then
		if self.TradeskillIDsToLocaleName[GetLocale()][id] then
			return self.TradeskillIDsToLocaleName[GetLocale()][id]
		end
	end
end
